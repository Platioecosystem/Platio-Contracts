...
/**
 * Platio token smart contract.
 */
contract PlatioToken is AbstractToken {
  /**
  ...
  /**
   * Create new Platio token smart contract, with given number of tokens issued
   ...
   */
  function PlatioToken (uint256 _tokenCount) public {
    owner = msg.sender;
